package com.hciproject.makanapa;
...
public class MakanApaApplication extends Application
{
	private static MakanApaApplication mInstance;

	private Tracker mTracker;


	public MakanApaApplication()
	{
		mInstance = this;
	}
	...
	public synchronized Tracker getTracker()
	{
		if(mTracker==null)
		{
			...
			analytics.setDryRun(!MakanApaConfig.ANALYTICS);

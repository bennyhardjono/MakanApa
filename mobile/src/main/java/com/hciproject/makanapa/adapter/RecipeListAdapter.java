package com.hciproject.makanapa.adapter;
...
public class RecipeListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>
{
	...
	{
		int height = (int) MakanApaApplication.getContext().getResources().getDimension(R.dimen.fragment_recipe_list_recycler_item_size);
		int marginTop = 0;

		if(position<mGridSpanCount)
		{
			TypedArray a = MakanApaApplication.getContext().obtainStyledAttributes(null, new int[]{android.R.attr.actionBarSize}, 0, 0);

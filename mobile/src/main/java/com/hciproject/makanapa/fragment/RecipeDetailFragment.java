...
import com.hciproject.makanapa.database.query.IngredientReadByRecipeQuery;
import com.hciproject.makanapa.database.query.Query;
import com.hciproject.makanapa.database.query.RecipeReadQuery;
import com.hciproject.makanapa.dialog.AboutDialogFragment;
import com.hciproject.makanapa.dialog.ServingsDialogFragment;
import com.hciproject.makanapa.listener.AnimateImageLoadingListener;
import com.hciproject.makanapa.utility.Logcat;
import com.hciproject.makanapa.utility.NetworkManager;
import com.hciproject.makanapa.utility.ResourcesHelper;
import com.hciproject.makanapa.view.ObservableStickyScrollView;
...
public class RecipeDetailFragment extends TaskFragment implements DatabaseCallListener, ServingsDialogFragment.ServingsDialogListener
{
	...
	public boolean onOptionsItemSelected(MenuItem item) 
	{
		...
		switch(item.getItemId())
		{
			...
			case R.id.menu_help:
				//startWebActivity(getString(R.string.app_store_uri, MakanApaApplication.getContext().getPackageName()));
				//Diisi dengan activity help
				return true;
	...
	private void renderViewBanner()
	{
		...
		// admob
		if(MakanApaConfig.ADMOB_RECIPE_DETAIL_BANNER && NetworkManager.isOnline(getActivity()))
		{
